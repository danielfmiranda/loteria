  ...
  render() {
    return (
      <div className={"gameContainer"}>
        {this.props.playerHasWonMessage === true ? (
          <WinningScreen />
        ) : (
          <div className={"gameContainer"}>
            <motion.div
            ...
            >
                  ...
                  <Row className={"userContentRow"}>
                    ...
                    <Col className={"userContentColumn"} xs={10}>
                      <div className={"userCard"}>
                        <Row
                          className={`${
                            this.props.playerDidNotWinMessage === false
                              ? `cardRow`
                              : `errorMessageRow`
                          }`}
                        >
                            ...
                            >
                              <BeanContainer
                                ...
                                userCardColumnsSelected={
                                  this.props.userCardColumnsSelected
                                }
                              />
                            </motion.div>
                          </Col>
                        ...
                        >
                          ...
                          <Col
                            className={
                              `cell ` + `${this.props.usersCards[10].className}`
                            }
                          ...
                          <Col
                            className={
                              `cell ` + `${this.props.usersCards[11].className}`
                            }
                        ...
                        >
                          <Col
                            className={
                              `cell ` + `${this.props.usersCards[12].className}`
                            }
                          ...
                          <Col
                            className={
                              `cell ` + `${this.props.usersCards[13].className}`
                            }
                          ...
                          <Col
                            className={
                              `cell ` + `${this.props.usersCards[14].className}`
                            }
                          ...
                          <Col
                            className={
                              `cell ` + `${this.props.usersCards[15].className}`
                            }
              ...
              <div className={"loteriaButtonContainer"}>
                <Button
                  onClick={this.props.checkIfPlayerWon}
                  className={"loteriaButton"}
                >
                  <h2> LOTERIA! </h2>
                </Button>
              </div>
